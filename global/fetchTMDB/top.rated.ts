...
export class TopRatedMoviesAPI {
  ...
  //     // Atualiza total pages e results se necessário
  //     if (json.total_pages && json.total_pages > coupledData[0]) {
  //       coupledData[0] = json.total_pages;
  //     }
  //     if (json.total_results && json.total_results > coupledData[1]) {
  ...
  //     // Mapeia os filmes para TopRatedResult completo
  //     const mappedMovies: TopRatedResult[] = json.results.map((movie: any, index: number) => {
  //       const baseMovie: TopRatedResult = {
  //         adult: movie.adult,
  ...
  //       // Adiciona campos opcionais conforme flags
  //       if (data?.frontEndPage || data?.dev) {
  //         baseMovie.page = page;
  //       }
  //       if (data?.dev) {
  //         const globalIndex = allMovies.length + index + 1;
  //         baseMovie.rank = globalIndex;
  //         baseMovie.rankPage = index + 1;
  //       }
